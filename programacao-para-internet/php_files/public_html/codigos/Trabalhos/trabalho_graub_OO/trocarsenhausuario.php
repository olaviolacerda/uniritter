<?php 		  require_once('functions.php');    indexusuarios();	trocarSenhaUserAdmin();?>
...
<div class="form">
<form name='form' method='post' action="trocarsenhausuario.php">
...
<div class="form-group">
	<label>Nova Senha:</label> <input  class="form-control" type="text" name="usuario[senha]" id="temporada" ><br/>
</div>


	<input  class="btn btn-primary" type="submit" name="submit" value="Alterar">
